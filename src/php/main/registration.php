                                ...
                                <div class="p-5">
									<form class="text-center py-md-5 text-ticketBlue needs-validation formInvalidFB" id="registrationForm" action="" method="POST" novalidate="">
									    ...
									    <div class="row text-left">
									        <div class="col-md-6">
												<div class="form-group">
													<label for="firstname" form="registrationForm" hidden>Nome</label>
									        ...
									        <div class="col-md-6">
									            <div class="form-group">
													<label for="lastname" form="registrationForm" hidden>Cognome</label>
									    ...
									    <div class="row text-left">
									        <div class="col-md-6">
									            <div class="form-group">
													<label for="CF" form="registrationForm" hidden>CF</label>
									    ...
									    <div class="row text-left">
									        <div class="col-md-6">
									            <div class="form-group">
													<label for="email" form="registrationForm" hidden>E-mail</label>
									    ...
									    <div class="row text-left">
									        <div class="col-md-6">
									            <div class="form-group">
													<label for="password" form="registrationForm" hidden>Password</label>
									        ...
									        <div class="col-md-6">
									            <div class="form-group">
													<label for="passwordconfirmation" form="registrationForm" hidden>Conferma Password</label>
