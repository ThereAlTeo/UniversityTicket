    <div class="my-3">
        <p class="h3 mb-2 text-ticketBlue"><?php echo $templateParams["headerPage"][0] ?></p>
    ...
    <?php if (strcmp($templateParams["headerPage"][2], "") != 0): ?>
        <p class="h6 mb-4 text-ticketBlue"> <?php echo $templateParams["headerPage"][0]." Nr. " ?><b><?php echo $templateParams["headerPage"][2] ?></b></p>
    <?php endif; ?>
